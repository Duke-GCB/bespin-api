...
def create_job_factory_for_answer_set(job_answer_set):
    ...
    job_vm_strategy = JobVMStrategy(vm_settings, job_flavor,
...
class JobVMStrategy(object):
    def __init__(self, vm_settings, job_flavor, volume_size_base, volume_size_factor, volume_mounts):
...
class JobFactory(object):
    ...
    def create_job(self):
        ...
        job = Job.objects.create(workflow_version=self.workflow_version,
                                 ...
                                 job_flavor=self.job_vm_strategy.job_flavor,
